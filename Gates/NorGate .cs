...
namespace Gates
{
    public class NorGate : LogicGate2, ILogicGate2
    {
        private int w, h;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawLine(Support.p, new PointF(0f, (float)h * 0.33f), new PointF(w * 0.25f, h * 0.33f));
            ...
            g.DrawArc(Support.p, new RectangleF(-(w * 0.55f), 0f, w * 1.3f, (float)h - 1f), 270f, 180f);
            g.DrawArc(Support.p, new RectangleF(w * 0.75f, h * 0.45f, w * 0.1f, h * 0.1f), 0f, 360f);
            g.DrawLine(Support.p, new PointF(w * 0.85f, h * 0.5f), new PointF((float)w - 1f, h * 0.5f));

            g.DrawString("Nor", this.Font, Support.boff, this.ClientRectangle, Support.sf());
        }
