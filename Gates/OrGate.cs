...
namespace Gates
{
    public class OrGate : LogicGate2, ILogicGate2
    {
        private int w, h;
        public void Set()
        {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawArc(Support.p, new RectangleF(-(w * 0.55f), 0, w * 1.3f, (float)(h - 1)), 270f, 180f);
            g.DrawLine(Support.p, new PointF(w * 0.75f, h * 0.5f), new PointF((float)w, h * 0.5f));

            g.DrawString("Or", this.Font, Support.boff, this.ClientRectangle, Support.sf());
        }
