...
namespace Gates
{
    public class AndGate: LogicGate2, ILogicGate2
    {
        private int w, h;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.DrawLine(Support.p, new PointF(0, h * 0.33f), new PointF(w * 0.25f, h * 0.33f));
            g.DrawLine(Support.p, new PointF(0, h * 0.67f), new PointF(w * 0.25f, h * 0.67f));
            g.DrawLine(Support.p, new PointF(w * 0.75f, h * 0.5f), new PointF((float)(w - 1), h * 0.5f));

            g.DrawString("And", this.Font, Support.boff, this.ClientRectangle, Support.sf());
        }
